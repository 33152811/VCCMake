...
if exist %sFile% (
  ...
  set "Path=%CurrentCD%Tools\CMake\bin;%CurrentCD%Tools\jom_1_1_3;%CurrentCD%Tools\Meson;%CurrentCD%Tools\bison\bin;%CurrentCD%Tools\Perl\Perl\bin;%CurrentCD%Tools\flex\bin;%CurrentCD%Tools\Python3.8;%SetupPath%\bin;%sPath%;%Path%"
) else (
  set "Path=%CurrentCD%Tools\CMake\bin;%CurrentCD%Tools\jom_1_1_3;%CurrentCD%Tools\Meson;%CurrentCD%Tools\bison\bin;%CurrentCD%Tools\Perl\Perl\bin;%CurrentCD%Tools\flex\bin;%CurrentCD%Tools\Python3.8;%SetupPath%\bin;%Path%"
)
